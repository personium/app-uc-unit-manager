...
function validateForm(ignoreCell, ignoreUser, ignorePass) {
    ...
    if (!ignoreCell && document.login.loginUrl.value == "") {
        ...
        document.getElementById("paswdspan").innerHTML =
 ...
 * @returns {Boolean}
 */
login_validation.prototype.validatePassword = function (
    password,
    passwordSpanID,
    userName,
    passwordID
...
login_validation.prototype.firstTimePasswordReset = function () {
    ...
    uLoginValidation.validateTempPassword(
        tempPasswordSpanID,
        userName,
        tempPassword,
        newPasswordSpanID,
        newRetypePassword,
        newRetypePasswordSpanID,
        newPassword
    );
};
 ...
 */
login_validation.prototype.validateTempPassword = function (
    tempPasswordSpanID,
    username,
    tempPassword,
    newPasswordSpanID,
    ...
    var CSRFTokenFirstTimeResetPassword = document.getElementById(
        "CSRFTokenFirstTimeResetPassword"
    ).value;
        ...
        $.ajax({
            ...
            success: function (jsonData) {
                if (jsonData["sessionTimeOut"] == "sessionTimeOut") {
                    ...
                    if (
                        uLoginValidation.validatePassword(
                            newPassword,
                            newPasswordSpanID,
                            username,
                            "newPassword"
                        ...
                        document.getElementById(newPasswordSpanID).innerHTML =
                            "";
                        if (
                            uLoginValidation.validateRetypePassword(
                                newRetypePassword,
                                newRetypePasswordSpanID,
                                newPassword,
                                "newRetypePassword"
                            ...
                            uLoginValidation.postNewPassword(
                                username,
                                newPassword,
                                true
                            );
                    ...
                    document.getElementById(tempPasswordSpanID).innerHTML =
                        getUiProps().MSG0401;
 ...
 * @param newPassword
 */
login_validation.prototype.postNewPassword = function (userName, newPassword) {
    var operation = "PASSWORD_SETTINGS";
    var CSRFTokenPassword = document.getElementById(
        "CSRFTokenFirstTimeResetPassword"
    ).value;
    $.ajax({
        data: {
        ...
        success: function (jsonData) {
            if (jsonData["sessionTimeOut"] == "sessionTimeOut") {
                ...
                window.location.href =
                    ...
                    "/templates/" +
                    sessionStorage.firstTimeUserSelectedLanguage +
                    "/home.jsp";
            }
        },
        error: function () {},
 ...
 * @param callback
 */
login_validation.prototype.readTermsAndConditionFile = function (
    fileName,
    callback
) {
        ...
        if (xmlhttp.readyState == 4) {
            if (xmlhttp.status == 200) {
                ...
                if (fileText.length > 0) {
                    ...
                    document.getElementById("dvTermsAndCondition").innerHTML =
                        getUiProps().MSG0403;
                }
...
login_validation.prototype.redirectLoginPage = function () {
    ...
    var CSRFTokenResetLastLogin = document.getElementById(
        "CSRFTokenResetLastLogin"
    ).value;
    var userName = firstTimeUserName;
    $.ajax({
        data: {
...
login_validation.prototype.ForgetPasswordMail = function () {
    ...
    var CSRFTokenForgetPassword = document.getElementById(
        "CSRFTokenForgotPassword"
    ).value;
        ...
        $.ajax({
            ...
            success: function (jsonData) {
                if (jsonData["sessionTimeOut"] == "sessionTimeOut") {
                    ...
                    jsonData["forgetPasswordMail"] ==
                    "forgetPasswordMailSentSuccess"
                ) {
                    $("#dvForgotPasswordInput").hide();
                    $("#dvForgotPasswordSuccess").show();
                } else if (
                    jsonData["forgetPasswordMail"] ==
                    "forgetPasswordMailSentFailure"
                ) {
                    $("#dvForgotPasswordInput").hide();
                    $("#dvForgotPasswordSuccess").show();
                    document.getElementById("spanForgotPassword").innerHTML =
                        "Error while sending mail. Please try again.";
